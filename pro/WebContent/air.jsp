<%-- 
    Document   : air
    Created on : 24 Apr, 2015, 10:13:47 PM
    Author     : praneethsai
--%>
...
<h2>I want a car for<br> <br><input type="radio" name="o" value="Round Trip">Airport to City&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="o" value="One Way Trip">City to Airport</h2></tr></table>
<table><tr><td><h2>Select City&nbsp;<select name="city" value="select a City">Select a City
...
<tr><td><h2>Date of journey&nbsp;&nbsp;&nbsp;
<input type="Date" name="d" required></h2></td></tr>
